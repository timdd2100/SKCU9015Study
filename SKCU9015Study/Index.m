...
- (void)viewDidLoad
{
    ...
    //in/it
    _indexTitle = [[NSArray alloc]initWithObjects:@"TableViews",@"Scroll Views", @"Labels", @"TextViews", Nil];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    // Configure the cell...
    cell.textLabel.text = [_indexTitle objectAtIndex:indexPath.row];
...
{
    ViewController *scrollview =     [self.storyboard instantiateViewControllerWithIdentifier:@"ScrollViewController"];
